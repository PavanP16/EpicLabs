...
class Employee{
    ...
    static String[] AttendanceList = new String[1000];
    ...
    public Employee(int employeeId, String employeeName, String attendanceStatus) {
        ...
        this.employeeName = employeeName;
        this.attendanceStatus = attendanceStatus;
        String id = intToString(employeeId);
        AttendanceList[employees] = id + "," +employeeName + "," + attendanceStatus;
        employees++;
    }
    ...
    static public String generateAttendanceReport(String[] attendanceList){
        ...
        report.append("Total Employees: ").append(attendanceList.length).append("\n");
